...
atoms: dict[str, list[tuple[str, str, int, str, str, str]]] = {
    ...
    "HOME-004": [("role-aware active events", "GAP-031", 2, "D36", "AT-HOME-001", "accepted_target"), ("history fallback when no active event", "GAP-031", 2, "D36", "AT-HOME-002", "accepted_target"), ("Only mine means player events, not all judged events", "GAP-031", 2, "D36", "AT-HOME-001", "accepted_target")],
    ...
    "HOME-007": [("finished match cards keep sides and score first, duration third, and exceptional outcomes distinct", "GAP-031", 2, "D36", "AT-HOME-003", "accepted_target"), ("secondary details remain accessible", "GAP-031", 2, "D36", "AT-HOME-003", "accepted_target"), ("winner marked at the server-confirmed side with accessible text, never inferred from display name", "GAP-031", 2, "D36", "AT-HOME-003", "accepted_target")],
