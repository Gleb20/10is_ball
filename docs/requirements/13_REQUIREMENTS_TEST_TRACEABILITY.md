...
| MATCH-001..017 | AT-MATCH-001..012, START/STOP, CANCEL-001..004, standalone VOID-001..003; tournament criteria after Q-MATCH-003 | strong engine/API slice; D23 cancel actor, D24 void, validation и concurrency gaps | `broken` | DATA-001/002/005/007, BUG-002/003/010, GAP-005 |
...
| TOURNAMENT-001..019 | AT-TRN-001..015; deterministic V2 SE/DE E2E; bounded V1 DE rejection; void criteria after Q-MATCH-003 | 455 bracket property scenarios + API/UI slices; V1 DE known hang path, tournament void outcome unresolved и нет full browser lifecycle | `broken` | SEC-006/007, DATA-002/006/007, GAP-006 |
