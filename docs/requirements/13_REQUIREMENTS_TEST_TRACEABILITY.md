...
| TOURNAMENT-001..019 | AT-TRN-001..015; deterministic V2 SE/DE E2E; bounded V1 DE rejection; void criteria after Q-MATCH-003 | 455 bracket property scenarios + API/UI slices; real-PG AT-TRN-010 fixture now checks final + third-place materialization and awaits green hosted rerun; V1 DE known hang path, tournament void outcome unresolved и нет full browser lifecycle | `broken` | SEC-006/007, DATA-002/006/007, GAP-006 |
