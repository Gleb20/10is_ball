...
## 4.0.0 — кандидат 2026-09-18

- Временно скрыты игровые и турнирные приглашения, вызовы и реванши в интерфейсе. Новый ручной матч и турнир создаются без приглашений; существующие записи и API сохраняются.
- Уведомления, счётчики и popup показывают доступные командные приглашения, передачу судейства и остальные события без скрытых игровых приглашений.


## 3.0.0 — 2026-09-13

- Добавлен полный цикл команд: создание, приглашения, управление составом, передача капитанства и архивирование.
- Завершены управление турнирами SE/DE, настройка и перестроение сетки, проведение и просмотр результатов.
- Добавлены согласование приглашений в матч, действия из уведомлений, явное завершение обучения и раздел помощи.
- Расширено администрирование пользователей и журнал действий; исправлены конкурентные операции и конфликт судейства со второго устройства.
- Улучшены размеры элементов управления, контраст, работа с клавиатурой, фокус диалогов и мобильная турнирная сетка.

## 2.1.0 — 2026-09-13

- Расширены создание матчей 2×2, выбор игроков команды и гостей, настройки правил и реванш.
- Добавлены неявка, ручная коррекция счёта и подачи, передача судейства выбранному игроку.
- Исправлены конкурентный старт, очередность подачи и сохранение истории судейства.

## 2.0.0 — 2026-09-13

- Полный собственный профиль, публичная карточка с защитой личных данных и управление другими сессиями.
- История с поиском, московскими датами, фильтрами и сохранением контекста при возврате из деталей.
- Командный рейтинг и переход из каждой строки к карточке соперника.

## 1.11.0 — 2026-09-13

- Главная: активные события, последние результаты, статистика, соперник и рейтинг за месяц.
- Улучшены восстановление сессии, выход из судейства, защита повторных отправок и обновление активных экранов.
- Добавлены сохранение шага обучения, состояние уведомлений, безопасное разблокирование и московские границы рейтинга.
- Усилены конкурентные приглашения и проверка миграций; сохранена история зависимых турнирных результатов при аннулировании.
