...
| Tournament organizer lifecycle | create/roster/settings/generate/start/play/stop/cancel/dissolve | `verified` | Wave D final local gate 1135/1135 implements organizer lifecycle, transactional start/stop/advancement, persisted stop reason, summary/current-next/duration/results/top-3 and personal highlight. Public Wave D release remains pending. | BUG-015, GAP-006 |
...
| API contract | Complete current OpenAPI and target spec | `verified` | Fresh gate route inventory84 operations /75 paths, full match to current OpenAPI; BUG-017409 mapping included | OPS-001, BUG-017 |
...
| Deterministic CI | Full repeatable green quality gate | `verified` | Fresh local verify:all1249/1249, no failed/skipped/todo/interrupted; hosted CI for this dirty candidate awaits authorized publication. Historical released CI evidence remains separate | TECH-001, TECH-002, OPS-004 |
