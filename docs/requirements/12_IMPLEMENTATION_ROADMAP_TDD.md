...
5. **UI-4 Judge** — immersive (без bottom nav), landscape, serve indicator, touch ≥ 44px. **done (v1.3.0)**
6. **UI-5 Auth & Admin** — auth layout; temp password copy CTA; admin dialogs. **done (v1.3.1)**
7. **UI-6 QA** — 360px smoke, a11y checklist, optional visual baselines. **done (v1.3.2)**

Phase 10 complete. Next: Phase 9 optional hardening or product backlog.
