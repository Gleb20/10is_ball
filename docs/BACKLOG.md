...
- **Local acceptance (2026-09-18):** [stage 2 final receipt](audits/2026-09-13-ux-ui/implementation/stage2-final-evidence/stage2-final-receipt.json) связывает base `e3b22876`, frozen R2 v2, единый CI 1291/1291, Terra PASS и root acceptance. Фактические player/current judge/organizer дела, текущая подпись судьи и иерархия Home проверены локально. Версия 4.1.0 затем опубликована с [read-only release parity](audit/evidence/stage2-public.json); телефонная приёмка не проведена, поэтому статус остаётся `verified_local`. Исторический экспертный GAP-015 остаётся `superseded_target`.
...
- **Local acceptance (2026-09-18):** [stage 2 final receipt](audits/2026-09-13-ux-ui/implementation/stage2-final-evidence/stage2-final-receipt.json): Home component 10/10, API Home 9/9, полный CI 1291/1291, Terra и root PASS. Ровно 23 принятых пользовательских атома этапа 2 имеют evidence-bound `verified_local`; HOME-003 main/a01 не закрыты. [Публикация 4.1.0](audit/evidence/stage2-public.json) подтверждает release parity, а не телефонное исследование или выполнение сценариев на публичных данных.
